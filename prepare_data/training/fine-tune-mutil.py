...
def get_fine_tune_model(symbol, arg_params, num_classes, layer_name):
    ...
    # net_downdress_fc = mx.symbol.BlockGrad(net_downdress_fc)
    net_hatclolor = mx.symbol.SoftmaxOutput(data=net_hatclolor_fc, name='hatcolor', ignore_label=-1, use_ignore=True)
    ...
    # net_downdress_fc = mx.symbol.BlockGrad(net_downdress_fc)
    net_umbrella = mx.symbol.SoftmaxOutput(data=net_umbrella_fc, name='umbrella', ignore_label=-1, use_ignore=True)
    ...
    net = mx.symbol.Group([net_gender, net_bag, net_handbag, net_backpack, net_updress, net_downdress, net_hatclolor, net_umbrella, net_shoes])
