...
#                #print(umbrella_dic)
                if dict['umbrella'] in umbrella_dic:
                    rec_line +='%f\t' % umbrella_dic[dict['umbrella']]
...
def parse_args():
    ...
    parser.add_argument('--json',type = str, help='train or test.',default='datav2_train.json')
...
if __name__ == '__main__':
    args = parse_args()
    print(args) 
    root = '/workspace/mnt/group/video-det/zhangfeiyun/projects/person/vss/mygit/peron_attribute/prepare_data/datav2' 
    rec_lines,idx = get_rec_lines(args)
    import random
    random.shuffle(rec_lines)
    out_file = 'attribute_0307_v2_cls9_'+args.dataset+'.lst'
