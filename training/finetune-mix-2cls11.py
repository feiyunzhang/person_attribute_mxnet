...
def get_fine_tune_model(symbol, arg_params, num_classes, layer_name):
    ...
    net_gender_mix = mx.symbol.SoftmaxOutput(data=net_gender_fc, name='gender_mix', grad_scale=0.1, ignore_label=-1,use_ignore=True)
    ...
    net_hat_mix =mx.symbol.SoftmaxOutput(data=net_hat_fc, name='hat_mix', grad_scale=0.1,ignore_label=-1,use_ignore=True)
    ...
    net_umbrella_mix = mx.symbol.SoftmaxOutput(data=net_umbrella_fc, name='umbrella_mix', grad_scale=0.1,ignore_label=-1,use_ignore=True)
    ...
    net_bag_mix = mx.symbol.SoftmaxOutput(data=net_bag_fc, name='bag_mix', grad_scale=0.1)
    ...
    net_handbag_mix = mx.symbol.SoftmaxOutput(data=net_handbag_fc, name='handbag_mix', grad_scale=0.1)
    ...
    net_backpack_mix = mx.symbol.SoftmaxOutput(data=net_backpack_fc, name='backpack_mix', grad_scale=0.1)
    net_backpack = lam*net_backpack + (1-net_backpack_mix)
    ...
    net_updress_mix = mx.symbol.SoftmaxOutput(data=net_updress_fc, name='updress_mix', ignore_label=-1, use_ignore=True)
    ...
    net_downdress_mix = mx.symbol.SoftmaxOutput(data=net_downdress_fc, name='downdress_mix', ignore_label=-1, use_ignore=True)
    ...
    net_hatcolor_mix = mx.symbol.SoftmaxOutput(data=net_hatcolor_fc, name='hatcolor_mix', ignore_label=-1, use_ignore=True)
    net_hatcolor = lam * net_hatcolor + (1-lam) * net_hatcolor_mix
    ...
    net_umbrellacolor_mix = mx.symbol.SoftmaxOutput(data=net_umbrellacolor_fc, name='umbrellacolor_mix', ignore_label=-1, use_ignore=True)
    net_umbrellacolor = lam * net_umbrellacolor + (1-lam) * net_umbrellacolor_mix
    ...
    net_shoes_mix = mx.symbol.SoftmaxOutput(data=net_shoes_fc, name='shoes_mix', ignore_label=-1, use_ignore=True)
